...
describe PurchaseOrdersController, :type => :controller do
  ...
  describe 'GET #search' do
    ...
    it 'renders the search view' do
      get :search, params: {id: @po.to_param} #, valid_session
      expect(response).to render_template :search
    end
    it 'lists nothing with empty search params' do
      get :search, params: {id: @po.to_param, search: ''} #, valid_session
    ...
    it 'finds lines that match search'  do
      ...
      get :search, params: {search: "pattern", id: @po.to_param} #, valid_session
  ...
  describe 'POST copy line' do
    ...
    it "creates a new line" do
      expect {
        post :copy_line, params: {id: @po.to_param, line_id: @po_line.to_param} #, valid_session
